...
const NewProject = () => {
    ...
    const handleSubmit = async() =>{
      await axios.post(`${process.env.REACT_APP_API_URL}/new-project`, {title, description, budget, skills, clientId: localStorage.getItem('userId'),  clientName: localStorage.getItem('username'),  clientEmail: localStorage.getItem('email')}).then(
        (response)=>{
